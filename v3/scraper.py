...
# Function to process biography content
def scrape_bio_page(bio_url, biography_content, folder_name="Mathaf Encyclopedia"):
    print(f"Processing bio content for: {bio_url}")
    ...
    with open(csv_name, mode='w', newline='', encoding='utf-8-sig', errors='replace') as csv_file:
